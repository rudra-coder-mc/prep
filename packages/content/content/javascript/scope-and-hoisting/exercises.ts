...
export const exercises: Exercise[] = [
  {
    ...
    difficulty: 'easy',
    prompt:
      'Write a file with five reads that each happen before their declaration, one var, one let, one const, one class and one function declaration. Predict each result before running it.',
    requirements: [
