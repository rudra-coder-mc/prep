...
rate themselves. What is left is the content: nine topics to convert onto the
...
1. `content/higher-order-functions`
2. `content/parameters-and-arguments`
3. `content/promises`
4. `content/prototypes`
5. `content/recursion-and-the-call-stack`
6. `content/scope-and-hoisting`
7. `content/this-binding`
8. `content/types-and-coercion`
9. `content/value-and-reference`
...
## 10. Enforce one open question per topic

Branch `improvement/open-question-cap`. Blocked by 1 to 9.

**What to build.** The content check stops accepting a second open question in a
topic, which it could not do while 72 questions are still waiting to be converted.
